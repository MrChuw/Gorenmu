...
class PyborgTwitter(object):
    ...
    def get_tweets(self) -> List[models.user.Activity.Status]:
        try:
    ...
    def is_reply_to_me(self, tweet: models.user.Activity.Status) -> bool:
    ...
    def _bail_if_only_images(self, tweet: models.user.Activity.Status) -> bool:
    ...
    def handle_tweet(self, tweet: models.user.Activity.Status) -> None:

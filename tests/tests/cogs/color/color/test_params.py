...
class Params:
    ...
    hex_color = [
        pytest.param(
            "en", "#FF4500 its Named: Vermilion https://color.mrchuw.com.br/hex/FF4500", marks=pytest.mark.en, id="en"
        ),
        pytest.param(
            "pt_BR",
    ...
    no_user_no_hex = [
        pytest.param("en", "User not found or valid hex color provided.", marks=pytest.mark.en, id="en"),
        pytest.param(

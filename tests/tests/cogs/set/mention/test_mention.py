...
async def test_decorators(interact, mock_context: MockContext, lang: str, helper: str, usage: str):
    ...
    mock_context.Asserter.assert_string(interact.translations.Mention.deco_usage("+"), usage)
    mock_context.Asserter.assert_string(interact.translations.Mention.deco_helper("+"), helper)

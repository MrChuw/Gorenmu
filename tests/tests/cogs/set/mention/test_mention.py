...
async def test_decorators(interact, mock_context: MockContext, lang: str, helper: str, usage: str):
    ...
    mock_context.Asserter.assert_string(interact.translations.Mention.deco_usage(mock_context, "+"), usage)
    mock_context.Asserter.assert_string(interact.translations.Mention.deco_helper(mock_context, "+"), helper)


async def base_mention(interact, mock_context: MockContext, lang: str, args: str, expected: str, success: bool = False):
    await mock_context.prepare_context(lang)
...
async def test_set_mention_on(interact, mock_context: MockContext, lang: str, args: str, expected: str):
    await base_mention(interact, mock_context, lang, args, expected, success=True)
...
async def test_set_mention_invalid(interact, mock_context: MockContext, lang: str, args: str, expected: str):
    await base_mention(interact, mock_context, lang, args, expected, success=False)

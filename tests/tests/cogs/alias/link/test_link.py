...
async def test_decorators(interact, mock_context: MockContext, lang: str, helper: str, usage: str):
    ...
    mock_context.Asserter.assert_string(interact.translations.Link.deco_usage(mock_context, "+"), usage)
    mock_context.Asserter.assert_string(interact.translations.Link.deco_helper(mock_context, "+"), helper)
...
async def test_no_content(interact, mock_context: MockContext, lang: str, expected: str):
    await alias_link(interact, mock_context, lang=lang, content=[], expected=expected, success=False)
...
async def test_wrong_username(interact, mock_context: MockContext, lang: str, expected: str):
    await alias_link(
        interact, mock_context, lang=lang, content=["Wrong_username", "."], expected=expected, success=False
    )

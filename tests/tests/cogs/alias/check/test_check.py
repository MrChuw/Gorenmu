...
async def test_decorators(interact, mock_context: MockContext, lang: str, helper: str, usage: str):
    ...
    decorator = mock_context.bot.TranslationManager.get_decorator(interact.check_alias, mock_context)
...
async def alias_check(
    ...
    with (
        patch.object(
            mock_context.bot.UploadThings, "upload_alias", return_value="https://alias.mrchuw.com.br/812d49c5415f474b"
        ),
        patch.object(mock_context.bot.UploadThings, "shortener", return_value="https://shlink.mrchuw.com.br/uQqt5"),
    ):

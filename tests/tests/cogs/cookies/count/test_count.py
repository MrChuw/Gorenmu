...
async def test_no_name(interact, mock_context: MockContext, lang: str, expected: str):
    await base_count(interact, mock_context, target_user=False, lang=lang, content=[], expected=expected)
...
async def test_bot_name(interact, mock_context: MockContext, lang: str, expected: str):
    await base_count(
        interact, mock_context, target_user=False, lang=lang, content=[mock_context.bot.bot_nick], expected=expected
    )
...
async def test_other_user(interact, mock_context: MockContext, lang: str, expected: str):
    await base_count(interact, mock_context, target_user=True, lang=lang, content=[], expected=expected)
...
async def test_user_not_found(interact, mock_context: MockContext, lang: str, expected: str):
    await base_count(interact, mock_context, target_user=False, lang=lang, content=["random_user"], expected=expected)

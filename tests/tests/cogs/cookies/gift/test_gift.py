...
async def call_and_assert(
    ...
    selected = (expected[0] if index is None else expected[index]) if isinstance(expected, list) else expected
...
async def base_gift_user(
    ...
    cookie_data = {"received": 25, "consumed": 54, "donated": 93, "stocked": 8534}

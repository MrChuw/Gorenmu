...
async def test_decorators(interact, mock_context: MockContext, lang: str, helper: str, usage: str):
    ...
    decorator = mock_context.bot.TranslationManager.get_decorator(interact.randomline, mock_context)
...
async def test_no_content(interact, mock_context: MockContext, lang: str, expected: str):
    await base_randomline(interact, mock_context, lang=lang, content="", re_expected=expected)
...
async def test_random_content(interact, mock_context: MockContext, lang: str, expected: str):
    await base_randomline(interact, mock_context, lang=lang, content="blablabla", re_expected=expected)
...
async def test_target_user(interact, mock_context: MockContext, lang: str, expected: str):
    await base_randomline(interact, mock_context, lang=lang, content="user:some_user_50", re_expected=expected)
...
async def test_target_channel(interact, mock_context: MockContext, lang: str, expected: str):
    await base_randomline(interact, mock_context, lang=lang, content="channel:channelname", re_expected=expected)
...
async def test_target_channel_no_messages(interact, mock_context: MockContext, lang: str, expected: str):
    await base_randomline(interact, mock_context, lang=lang, content="channel:some_user_49", re_expected=expected)
...
async def test_target_user_no_messages(interact, mock_context: MockContext, lang: str, expected: str):
    await base_randomline(interact, mock_context, lang=lang, content="user:some_user_51", expected=expected)

...
def rule34_from_dict(s: Any) -> List[Rule34Element]:
    return from_list(Rule34Element.from_dict, s)


def rule34_to_dict(x: List[Rule34Element]) -> Any:
    return from_list(lambda x: to_class(Rule34Element, x), x)

...
def konachan_from_dict(s: Any) -> List[KonachanElement]:
    return from_list(KonachanElement.from_dict, s)


def konachan_to_dict(x: List[KonachanElement]) -> Any:
    return from_list(lambda x: to_class(KonachanElement, x), x)

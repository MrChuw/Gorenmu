...
class The0_P:
    ...
    def from_dict(obj: Any) -> 'The0_P':
        ...
        return The0_P(type, height, width, urls)
...
@dataclass
class Alternates:
    the_480_p: Optional[The0_P] = None
    ...
    def from_dict(obj: Any) -> 'Alternates':
        ...
        the_720_p = from_union([The0_P.from_dict, from_none], obj.get("720p"))
        return Alternates(the_480_p, original, the_720_p)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.the_480_p is not None:
            result["480p"] = from_union([lambda x: to_class(The0_P, x), from_none], self.the_480_p)
        if self.original is not None:
            result["original"] = from_union([lambda x: to_class(Original, x), from_none], self.original)
        if self.the_720_p is not None:
            result["720p"] = from_union([lambda x: to_class(The0_P, x), from_none], self.the_720_p)
        return result
...
class Sample:
    ...
    def from_dict(obj: Any) -> 'Sample':
        ...
        width = from_union([from_int, from_none], obj.get("width"))
        url = from_union([from_none, from_str], obj.get("url"))
        alternates = from_union([Alternates.from_dict, from_none], obj.get("alternates"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.alternates is not None:
            result["alternates"] = from_union([lambda x: to_class(Alternates, x), from_none], self.alternates)
        return result
...
def e621_from_dict(s: Any) -> E621:
    return E621.from_dict(s)


def e621_to_dict(x: E621) -> Any:
    return to_class(E621, x)

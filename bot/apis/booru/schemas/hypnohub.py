...
def hypnohub_from_dict(s: Any) -> List[HypnohubElement]:
    return from_list(HypnohubElement.from_dict, s)


def hypnohub_to_dict(x: List[HypnohubElement]) -> Any:
    return from_list(lambda x: to_class(HypnohubElement, x), x)

...
def tbib_from_dict(s: Any) -> List[TbibElement]:
    return from_list(TbibElement.from_dict, s)


def tbib_to_dict(x: List[TbibElement]) -> Any:
    return from_list(lambda x: to_class(TbibElement, x), x)

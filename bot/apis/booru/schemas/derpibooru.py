...
class Derpibooru:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'Derpibooru':
        assert isinstance(obj, dict)
        ...
        return Derpibooru(total, images, interactions)
...
def derpibooru_from_dict(s: Any) -> Derpibooru:
    return Derpibooru.from_dict(s)


def derpibooru_to_dict(x: Derpibooru) -> Any:
    return to_class(Derpibooru, x)

...
from bot.apis.deeptranslator.deep_translator.constants import BASE_URLS, LINGUEE_LANGUAGES_TO_CODES
...
class LingueeTranslator(BaseTranslator):
    ...
    def translate(self, word: str, return_all: bool = False, **kwargs) -> Union[str, List[str]]:
        """

...
if TYPE_CHECKING:
    ...
    from .userid import UserIdCmd


class Translations(TranslationBase):
    def __init__(self, bot: Gorenmu, parent: UserIdCmd) -> None:
        super().__init__(bot, __file__)
        self.parent: UserIdCmd = parent

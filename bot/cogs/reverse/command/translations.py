...
if TYPE_CHECKING:
    ...
    from .reverse import ReverseCmd


class Translations(TranslationBase):
    def __init__(self, bot: Gorenmu, parent: ReverseCmd) -> None:
        super().__init__(bot, __file__)
        self.parent: ReverseCmd = parent
    ...
    class Reverse(TBase):
        ...
        def deco_commands(self, *args, **kwargs) -> CommandExemples:
            return CommandExemples([{"args": self.get_text("cmd_args"), "response": self.get_text("cmd_res")}])

...
class PixelSortCmd(commands.CustomComponent):
    ...
    async def pixel_sorting(self, ctx: Context, *, args) -> Response:  # NOQA
        ...
        try:
            ...
            return translations.took_too_long(timeout.duration())
        ...
        return translations.image(shortened)

...
if TYPE_CHECKING:
    ...
    from bot.ext import Response, TranslationBase
...
class User(Base, TimestampMixin, ContentMixin):
    ...
    @staticmethod
    async def create_or_update(ctx: Context) -> User | None:
    ...
    @staticmethod
    async def create_or_none(user_id: int, name: str, **kwargs) -> User | None:

...
class LotteryTools:  # TODO: Lottery.
    ...
    @staticmethod
    async def check_numbers_async(ctx: Context, translations: BaseTranslations.Lottery.Bet) -> Response | List[int]:
    ...
    async def bet(self, ctx: Context, translations: BaseTranslations.Lottery.Lottery) -> Response:

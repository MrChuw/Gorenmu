...
class LotteryTools:  # TODO: Lottery.
    ...
    @staticmethod
    def check_numbers(message: Message, ctx: Context, translations: EnUsDecorators.Lottery.Lottery) -> (
    ...
    @staticmethod
    async def check_numbers_async(ctx: Context, translations: EnUsDecorators.Lottery.Bet) -> Response | List[int]:
    ...
    async def bet(self, ctx: Context, translations: EnUsDecorators.Lottery.Lottery) -> Response:
    ...
    async def consultation(self, ctx: Context, translations: EnUsDecorators.Lottery.Lottery) -> Response:
        ids = []
        value = 0

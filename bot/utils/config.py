...
class ApisConfig:
    def __init__(self, data: dict[str, dict]) -> None:
        ...
        self.file_upload_url: URL = URL(data.get("file_upload_url", "https://uploadthing.com"))
        self.file_upload_api_key: str = data.get("file_upload_api_key", "https://upload.exemple.org")

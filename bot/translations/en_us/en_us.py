...
afks = {
    ...
    "shower": Status(
        "shower", "🚿", "went to shower", "in the shower", "took a shower", "the shower"
    ),
    ...
    class Activity(BaseTranslations.Activity):
        class Afk(BaseTranslations.Activity.Afk):
            ...
            afk_response: Response = Response(
                {"success": True, "response": "{}: {}", "is_response": False}
            )
        ...
        class IsAfk(BaseTranslations.Activity.IsAfk):
            ...
            bot_nick: Response = Response(
                {
                    "success": False,
                    "response": "I am always here... watching.",
                    "is_response": False,
                }
            )
            author_nick: Response = Response(
                {
                    "success": False,
                    "response": "you are not working... obviously",
                    "is_response": False,
                }
            )
        ...
        class RAfk(BaseTranslations.Activity.RAfk):
            time_expired: Response = Response(
                {
                    "success": False,
                    "response": "The time to return has passed.",
                    "is_response": False,
                }
            )
            is_afk: Response = Response(
            ...
            is_not_afk: Response = Response(
                {"success": False, "response": "you are not AFK.", "is_response": False}
            )

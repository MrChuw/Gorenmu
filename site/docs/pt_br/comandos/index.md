...
|           Nome do Comando           |                                           Descrição                                            | Extras |
| :---------------------------------: | :--------------------------------------------------------------------------------------------: | :----: |
...
|          [count](count.md)          |                   Conta a quantidade de símbolos em um texto ou em uma URL.                    |        |
| [hypertranslate](hypertranslate.md) | Traduz um texto para idiomas aleatórios dependendo da quantidade de vezes que o usuário pedir. |        |
|    [randomcolor](randomcolor.md)    |                                    Envia uma cor aleatória.                                    |        |
|        [reverse](reverse.md)        |                                       Reverte um texto.                                        |        |

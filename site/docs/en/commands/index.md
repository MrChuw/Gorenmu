...
|             Command Name            |                                      Description                                       | Extras |
| :---------------------------------: | :------------------------------------------------------------------------------------: | :----: |
...
|          [count](count.md)          |                    Counts the number of symbols in a text or a URL.                    |        |
| [hypertranslate](hypertranslate.md) | Translates a text into random languages depending on how many times the user requests. |        |
|    [randomcolor](randomcolor.md)    |                                 Sends a random color.                                  |        |
|        [reverse](reverse.md)        |                                    Reverses a text.                                    |        |
